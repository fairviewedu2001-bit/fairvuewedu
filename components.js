// This file contains your Header and Footer. 
// Change it here once, and it updates across all HTML pages!

const headerHTML = `
    <header>
        <a href="index.html" class="logo-container">
            <img src="images/logo.png" alt="Fairview Education Logo" class="logo-img" onerror="this.src='https://via.placeholder.com/60x60?text=Logo';">
        ...
        <div class="footer-content">
            <div class="footer-col animate-on-scroll">
                <div style="display:flex; align-items:center; gap:10px; margin-bottom: 1.5rem;">
                    <img src="images/logo.png" alt="Logo" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%;" onerror="this.src='https://via.placeholder.com/40x40?text=Logo';">
...
document.addEventListener('DOMContentLoaded', () => {
    // 1. Inject Header and Footer into the page
    ...
    // 2. Highlight the active link based on the page's data-page attribute
