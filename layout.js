// This file lives in the 'components' folder.
// It stores your Header and Footer so you only have to edit them once.

const headerHTML = `
    <header>
        <a href="index.html" class="logo-container">
            <!-- Updated to logo.jfif as requested -->
            <img src="images/logo.jfif" alt="Fairview Education Logo" class="logo-img" onerror="this.src='https://via.placeholder.com/60x60?text=Logo';">
        ...
        <div class="footer-content">
            <div class="footer-col animate-on-scroll">
                <div style="display:flex; align-items:center; gap:10px; margin-bottom: 1.5rem;">
                    <!-- Updated to logo.jfif as requested -->
                    <img src="images/logo.jfif" alt="Logo" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%;" onerror="this.src='https://via.placeholder.com/40x40?text=Logo';">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize Mobile Menu (runs after injection)
