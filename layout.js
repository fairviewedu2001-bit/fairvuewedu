...
const headerHTML = `
    <header>
        <a href="index.html" class="logo-container">
            <img src="logo.jpg" alt="Fairview Education Logo" class="logo-img">
        ...
        <div class="footer-content">
            <div class="footer-col animate-on-scroll">
                <div style="display:flex; align-items:center; gap:10px; margin-bottom: 1.5rem;">
                    <img src="logo.jpg" alt="Logo" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%; background: white;">
                ...
                <div class="social-links">
                    <a href="https://www.facebook.com/share/1CavdD9xa8/" target="_blank"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="footer-col animate-on-scroll delay-2">
                ...
                <div style="display:flex; gap:10px; margin-bottom:10px; color:#a0a0b0;">
                    ...
                    <span>Balaju, P8H4+35 Kathmandu, Nepal</span>
                </div>
                <div style="display:flex; gap:10px; margin-bottom:10px; color:#a0a0b0;">
